...
const ToastContent = ({
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="font-suit font-bold text-20 leading-none tracking-[var(--letter-spacing--0.35)]">
        남은 예산
      </span>
      <span className="font-suit font-bold text-20 leading-none tracking-[var(--letter-spacing--0.35)]">
        {formattedAmount}
...
export const Toast = ({ amount = '0', variant, message, onClose }: ToastProps) => {
  ...
  return (
    ...
    >
      {/* 아이콘 */}
      <div className="flex-shrink-0 w-[var(--icon-24)] h-[var(--icon-24)] relative">
      ...
      <div className="flex-1 flex flex-col justify-center ml-3">
        ...
        <div className="mobile:flex tablet:hidden desktop:hidden justify-between items-center w-full">
          <div className="flex flex-col font-suit font-bold text-14 leading-[160%] tracking-[var(--letter-spacing--0.35)]">
