...
import PurchaseHistoryDetailInfoOrg from './PurchaseHistoryDetailInfoOrg';

const meta = {
  title: 'Features/PurchaseHistory/Organisms/PurchaseHistoryDetailInfoOrg',
  component: PurchaseHistoryDetailInfoOrg,
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    docs: {
...
} satisfies Meta<typeof PurchaseHistoryDetailInfoOrg>;

export default meta;

type Story = StoryObj<typeof PurchaseHistoryDetailInfoOrg>;
