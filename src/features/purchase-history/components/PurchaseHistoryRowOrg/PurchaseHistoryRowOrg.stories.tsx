...
import PurchaseHistoryRowOrg from './PurchaseHistoryRowOrg';

const meta = {
  title: 'Features/PurchaseHistory/Organisms/PurchaseHistoryRowOrg',
  component: PurchaseHistoryRowOrg,
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
    nextjs: {
...
} satisfies Meta<typeof PurchaseHistoryRowOrg>;

export default meta;

type Story = StoryObj<typeof PurchaseHistoryRowOrg>;
