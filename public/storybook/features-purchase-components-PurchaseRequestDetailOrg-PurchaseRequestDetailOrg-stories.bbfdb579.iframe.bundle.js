      ...
      const __WEBPACK_DEFAULT_EXPORT__ = {
        ...
        WithBudgetInfo = {
          args: {
            ...
            budgetInfo: { monthlySpending: 5e5, remainingBudget: 2e6, budgetAfterPurchase: 1952e3 },
          },
          parameters: {
            docs: {
              description: {
        ...
        __namedExportsOrder = ['Default', 'WithBudgetInfo', 'LongRequestMessage', 'Rejected'];
      ((Default.parameters = {
        ...Default.parameters,
        docs: {
        ...
        (WithBudgetInfo.parameters = {
          ...WithBudgetInfo.parameters,
          docs: {
            ...WithBudgetInfo.parameters?.docs,
            source: {
              originalSource:
                "{\n  args: {\n    purchaseRequest: mockPurchaseRequest,\n    budgetInfo: {\n      monthlySpending: 500000,\n      remainingBudget: 2000000,\n      budgetAfterPurchase: 1952000\n    }\n  },\n  parameters: {\n    docs: {\n      description: {\n        story: '예산 정보가 포함된 구매 요청 상세 정보를 표시합니다.\\n\\n**요청 정보:**\\n- 요청인: 김스낵\\n- 요청 날짜: 2025년 7월 5일 09:30\\n- 요청 메시지: 회의용 음료가 필요합니다. 가능한 빨리 구매 부탁드립니다.\\n\\n**예산 정보:**\\n- 이번 달 지출액: 500,000원\\n- 이번 달 남은 예산: 2,000,000원\\n- 구매 후 예산: 1,952,000원'\n      }\n    }\n  }\n}",
              ...WithBudgetInfo.parameters?.docs?.source,
            },
          },
        }),
