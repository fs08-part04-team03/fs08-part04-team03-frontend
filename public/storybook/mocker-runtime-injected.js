...
var __defProp = Object.defineProperty,
  ...
  MockerRegistry = class {
    ...
    register(typeOrEvent, raw, id, url, factoryOrRedirect) {
      const type = 'object' == typeof typeOrEvent ? typeOrEvent.type : typeOrEvent;
      ...
      if ('string' != typeof raw) throw new TypeError('[vitest] Mocks require a raw string.');
      if ('string' != typeof url) throw new TypeError('[vitest] Mocks require a url string.');
      if ('string' != typeof id) throw new TypeError('[vitest] Mocks require an id string.');
      if ('manual' === type) {
  ...
  AutomockedModule = class {
    constructor(raw, id, url) {
      (__publicField(this, 'type', 'automock'), (this.raw = raw), (this.id = id), (this.url = url));
    }
  ...
  AutospiedModule = class _AutospiedModule {
    constructor(raw, id, url) {
      (__publicField(this, 'type', 'autospy'), (this.raw = raw), (this.id = id), (this.url = url));
    }
    static fromJSON(data) {
  ...
  ManualMockedModule = class _ManualMockedModule {
    ...
    async resolve() {
      ...
      if (null === exports || 'object' != typeof exports || Array.isArray(exports))
        throw new TypeError(
  ...
  const finalizers = new Array(),
    ...
    mockPropertiesOf = (container, newContainer) => {
      ...
      for (const { key: property, descriptor } of getAllMockableProperties(
        ...
        const isFunction = type.includes('Function') && 'function' == typeof value;
        if ((isFunction && !value._isMockFunction) || 'Object' === type || 'Module' === type) {
              ...
              let mockFunction = function () {
                if (this instanceof newContainer[property])
                  for (const { key, descriptor: descriptor2 } of getAllMockableProperties(
                    ...
                    if (getType(value2).includes('Function') && 'function' == typeof value2) {
...
var RefTracker = class {
  constructor() {
    (__publicField(this, 'idMap', new Map()), __publicField(this, 'mockedValueMap', new Map()));
  }
  getId(value) {
...
function normalizeWindowsPath(input = '') {
  return input
    ? input.replace(/\\/g, '/').replace(_DRIVE_LETTER_START_RE, (r) => r.toUpperCase())
    : input;
}
var _UNC_REGEX = /^[/\\]{2}/,
...
function requireReactIs$1() {
  return (
    hasRequiredReactIs$1 ||
      ((hasRequiredReactIs$1 = 1), (reactIs$1.exports = requireReactIs_development$1())),
    reactIs$1.exports
  );
}
var hasRequiredReactIs_development,
  ...
  ReactIs19 = _mergeNamespaces({ __proto__: null, default: index$1 }, [reactIsExports$1]),
  reactIs = { exports: {} },
  reactIs_development = {};
    ...
    hasRequiredReactIs_development ||
      ...
      (function () {
        ...
        ((reactIs_development.ContextConsumer = ContextConsumer),
          ...
          (reactIs_development.isConcurrentMode = function isConcurrentMode(object) {
            return (
          ...
          (reactIs_development.isContextConsumer = function isContextConsumer(object) {
            return typeOf(object) === REACT_CONTEXT_TYPE;
          }),
          (reactIs_development.isContextProvider = function isContextProvider(object) {
          ...
          (reactIs_development.isSuspenseList = function isSuspenseList(object) {
            return typeOf(object) === REACT_SUSPENSE_LIST_TYPE;
          }),
          (reactIs_development.isValidElementType = function isValidElementType(type) {
            return (
              'string' == typeof type ||
              'function' == typeof type ||
              type === REACT_FRAGMENT_TYPE ||
...
function requireReactIs() {
  return (
    hasRequiredReactIs ||
      ((hasRequiredReactIs = 1), (reactIs.exports = requireReactIs_development())),
    reactIs.exports
  );
}
var reactIsExports = requireReactIs(),
  index = getDefaultExportFromCjs(reactIsExports),
  ReactIs18 = _mergeNamespaces({ __proto__: null, default: index }, [reactIsExports]),
  reactIsMethods = [
    'isAsyncMode',
    'isConcurrentMode',
    'isContextConsumer',
        ...
        for (
            ...
            case 'InterpolationInJSX':
                          ...
                          ((Template.lastIndex = lastIndex),
                            ...
                            '${' === match[1]
                              ? ((lastSignificantToken = '?InterpolationInTemplate'),
                                (postfixIncDec = !1),
                                yield { type: 'TemplateMiddle', value: match[0] })
                              : (stack.pop(),
                                (postfixIncDec = !0),
                                yield {
                                  type: 'TemplateTail',
              ...
              if (((StringLiteral.lastIndex = lastIndex), (match = StringLiteral.exec(input)))) {
                ((lastIndex = StringLiteral.lastIndex),
                  (lastSignificantToken = match[0]),
                  (postfixIncDec = !0),
                  yield { type: 'StringLiteral', value: match[0], closed: void 0 !== match[2] });
                continue;
              }
            ...
            case 'JSXTagEnd':
              if (((JSXPunctuator.lastIndex = lastIndex), (match = JSXPunctuator.exec(input)))) {
                switch (
                  ...
                  case '>':
                    (stack.pop(),
                      '/' === lastSignificantToken || 'JSXTagEnd' === mode.tag
                        ? ((nextLastSignificantToken = '?JSX'), (postfixIncDec = !0))
                  ...
                  case '/':
                    '<' === lastSignificantToken &&
                      (stack.pop(),
                      'JSXChildren' === stack[stack.length - 1].tag && stack.pop(),
              ...
              if (((JSXString.lastIndex = lastIndex), (match = JSXString.exec(input)))) {
                ((lastIndex = JSXString.lastIndex),
                  (lastSignificantToken = match[0]),
                  yield { type: 'JSXString', value: match[0], closed: void 0 !== match[2] });
                continue;
              }
              break;
            case 'JSXChildren':
          ...
          ((WhiteSpace.lastIndex = lastIndex),
            (match = WhiteSpace.exec(input))
              ? ((lastIndex = WhiteSpace.lastIndex), yield { type: 'WhiteSpace', value: match[0] })
              : ((LineTerminatorSequence.lastIndex = lastIndex),
                (match = LineTerminatorSequence.exec(input))
                  ? ((lastIndex = LineTerminatorSequence.lastIndex),
                    (postfixIncDec = !1),
                    KeywordsWithNoLineTerminatorAfter.test(lastSignificantToken) &&
...
function normalizeWindowsPath2(input = '') {
  return input
    ? input.replace(/\\/g, '/').replace(_DRIVE_LETTER_START_RE2, (r) => r.toUpperCase())
    : input;
}
...
var resolve = function (...arguments_) {
  ...
  for (
    let index2 =
      (arguments_ = arguments_.map((argument) => normalizeWindowsPath2(argument))).length - 1;
    ...
    path &&
      0 !== path.length &&
      ((resolvedPath = `${path}/${resolvedPath}`), (resolvedAbsolute = isAbsolute2(path)));
  }
  return (
...
function parseSingleFFOrSafariStack(raw) {
  ...
  const functionNameRegex = /((.*".+"[^@]*)?[^@]*)(@)/,
    ...
    [url, lineNumber, columnNumber] = extractLocation(line.replace(functionNameRegex, ''));
...
function parseSingleV8Stack(raw) {
  ...
  return file && lineNumber && columnNumber
    ? (method.startsWith('async ') && (method = method.slice(6)),
      ...
      { method, file, line: Number.parseInt(lineNumber), column: Number.parseInt(columnNumber) })
    : null;
}
function createCompilerHints(options) {
  ...
  return {
    ...
    importActual: async (path) => _mocker().importActual(path, getImporter('importActual')),
    importMock: async (path) => _mocker().importMock(path, getImporter('importMock')),
  };
}
function getImporter(name) {
  const stackArray = createSimpleStackTrace({ stackTraceLimit: 5 }).split('\n'),
    importerStackIndex = stackArray.findIndex(
      (stack2) => stack2.includes(` at Object.${name}`) || stack2.includes(`${name}@`)
    ),
    ...
    async importActual(id, importer) {
      ...
      return this.wrapDynamicImport(() => import(actualUrl)).then((mod) => {
        ...
        return (null == m ? void 0 : m.__esModule)
          ? m
          : {
              ...(('object' == typeof m && !Array.isArray(m)) || 'function' == typeof m ? m : {}),
              default: m,
            };
      });
    }
    async importMock(rawId, importer) {
      ...
      if ('automock' === mock.type || 'autospy' === mock.type) {
        const url = new URL(`/@id/${resolvedId}`, location.href),
          ...
          moduleObject = await import(`${url.pathname}${query}&mock=${mock.type}${url.hash}`);
    ...
    queueMock(rawId, importer, factoryOrOptions) {
      const promise = this.rpc
        ...
        .then(async ({ redirectUrl, resolvedId, resolvedUrl, needsInterop, mockType }) => {
          ...
          ((module =
            'manual' === mockType
              ? this.registry.register('manual', rawId, resolvedId, mockUrl, factory)
              : 'autospy' === mockType
                ? this.registry.register('autospy', rawId, resolvedId, mockUrl)
                : 'redirect' === mockType
                  ? this.registry.register('redirect', rawId, resolvedId, mockUrl, mockRedirect)
                  : this.registry.register('automock', rawId, resolvedId, mockUrl)),
...
function registerModuleMocker(interceptor) {
  const mocker = new BuildModuleMocker(
    interceptor('__vitest_mocker__'),
    {
      ...
      resolveMock: (id, importer, options) => rpc('resolveMock', { id, importer, options }),
