(self.webpackChunkproject_name = self.webpackChunkproject_name || []).push([
  [1106],
  {
    ...
    './node_modules/next/dist/client/link.js'(module, exports, __webpack_require__) {
      ...
      const _interop_require_wildcard = __webpack_require__(
        ...
        prefetched =
          (__webpack_require__('./node_modules/next/dist/shared/lib/utils/error-once.js'),
          new Set());
      function prefetch(router, href, as, options) {
        if ('undefined' != typeof window && (0, _islocalurl.isLocalURL)(href)) {
      ...
      const Link = _react.default.forwardRef(function LinkComponent(props, forwardedRef) {
          ...
          const childRef = legacyBehavior
            ...
            setRef = (0, _usemergedref.useMergedRef)(setIntersectionWithResetRef, childRef);
          _react.default.useEffect(() => {
            router && isVisible && prefetchEnabled && prefetch(router, href, as, { locale });
                  ...
                  (e.defaultPrevented ||
                    (function linkClicked(
                      ...
                      if (!(0, _islocalurl.isLocalURL)(href))
                        return void (replace && (e.preventDefault(), location.replace(href)));
                      (e.preventDefault(),
                        (() => {
                          if (onNavigate) {
                            let isDefaultPrevented = !1;
                            if (
                              (onNavigate({
                                preventDefault: () => {
                    ...
                    })(e, router, href, as, replace, shallow, scroll, locale, onNavigate)));
            },
            onMouseEnter(e) {
              (legacyBehavior || 'function' != typeof onMouseEnterProp || onMouseEnterProp(e),
                ...
                router &&
                  prefetch(router, href, as, { locale, priority: !0, bypassPrefetchedCheck: !0 }));
            },
            onTouchStart: {
              NODE_ENV: 'production',
              NODE_PATH: [],
          ...
          if ((0, _utils.isAbsoluteUrl)(as)) childProps.href = as;
            ...
            const curLocale = void 0 !== locale ? locale : router?.locale,
              localeDomain =
        ...
        LinkStatusContext = (0, _react.createContext)({ pending: !1 }),
        useLinkStatus = () => (0, _react.useContext)(LinkStatusContext),
        _default = Link;
      ('function' == typeof exports.default ||
        ('object' == typeof exports.default && null !== exports.default)) &&
        void 0 === exports.default.__esModule &&
    ...
    './node_modules/next/dist/shared/lib/utils/error-once.js'(__unused_webpack_module, exports) {
      'use strict';
      (Object.defineProperty(exports, '__esModule', { value: !0 }),
