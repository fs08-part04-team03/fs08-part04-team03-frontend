try {
  (() => {
    ...
    var N = 'storybook/a11y',
      ...
      Z = { RESULT: ya, REQUEST: ba, RUNNING: ha, ERROR: Sa, MANUAL: ga, SELECT: Ea },
    ...
    var rl = __STORYBOOK_API__,
      {
        ...
        internal_fullTestProviderStore: Al,
        internal_universalChecklistStore: xl,
    ...
    var zm = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        SAVE_STORY_REQUEST: Ad,
        SAVE_STORY_RESPONSE: xd,
        SELECT_STORY: $d,
        SET_CONFIG: Rd,
    ...
    var H = { VIOLATION: 'violations', PASS: 'passes', INCOMPLETION: 'incomplete' },
      ...
      rr = (e) => {
        ...
        let T = E(() => {
          ...
          F = D(() => p?.[s.tab]?.every((m) => $.has(`${s.tab}.${m.id}`)) ?? !1, [p, $, s.tab]),
          ce = E((m, b, f) => {
            m.stopPropagation();
            let _ = `${b}.${f.id}`;
          ...
          ae = E(
            (m, b) => {
              g === b &&
                ...
                setTimeout(() => {
                  (c((f) => (f.status === 'ran' ? { ...f, status: 'ready' } : f)),
                    R((f) => {
                      if (f.size === 1) {
                        let [_] = f.values();
                        document
          ...
          ue = E(
            (m, b) => {
              let [f, _] = m.split('.'),
                { helpUrl: O, nodes: fe } = p?.[f]?.find((re) => re.id === _) || {},
                ye = O && window.open(O, '_blank', 'noopener,noreferrer');
              if (fe && !ye) {
                let re =
                  fe.findIndex((be) => b.selectors.some((da) => da === String(be.target))) ?? -1;
                if (re !== -1) {
                  let be = `${f}.${_}.${re + 1}`;
                  (R(new Map([[`${f}.${_}`, be]])),
                    setTimeout(() => {
          ...
          pe = E(
            ({ newPhase: m }) => {
              m === 'loading'
                ? c((b) => ({ ...b, results: void 0, status: l ? 'manual' : 'initial' }))
                : m === 'afterEach' && !l && c((b) => ({ ...b, status: 'running' }));
            },
            [l, c]
          ),
          Y = dt(
          ...
          o &&
            c((m) => {
              let b = { ...m.ui, highlighted: !0 },
                [f] = o.split('.') ?? [];
              return (f && Object.values(H).includes(f) && (b.tab = f), { ...m, ui: b });
            });
        }, [o]),
          k(() => {
            if ((Y(xe, `${N}/selected`), Y(xe, `${N}/others`), !s.highlighted || at)) return;
            let m = Array.from($.values()).flatMap((f) => {
              let [_, O, fe] = f.split('.');
              if (_ !== s.tab) return [];
              let ye = p?.[_]?.find((re) => re.id === O)?.nodes[Number(fe) - 1]?.target;
              return ye ? [String(ye)] : [];
            });
            m.length &&
              Y(Ae, {
                ...
                menu: p?.[s.tab].map((f) => {
                  ...
                  return [
                    { id: `${s.tab}.${f.id}:info`, title: qe(f), description: Ve(f), selectors: _ },
                    {
                      id: `${s.tab}.${f.id}`,
                      iconLeft: 'info',
                      iconRight: 'shareAlt',
        ...
        let ma = D(() => {
          if (!h) return null;
          if (h === 'status-value:success' && p?.violations.length) return 'cliPassedBrowserFailed';
    ...
    var Ye = w((e, t) => {
      ...
      if (l) {
        let o = l.props.children,
          u = i.map((c) =>
            c === l ? (U.count(o) > 1 ? U.only(null) : j(o) ? o.props.children : null) : c
          );
    ...
    function ur(e) {
      let t = e + 'CollectionProvider',
        ...
        o = (g) => {
          ...
          return r.createElement(i, { scope: h, itemMap: R, collectionRef: $ }, T);
        };
    ...
    var He = 'rovingFocusGroup.onEntryFocus',
      ...
      zt = w((e, t) =>
        d(
          ...
          d(Ke.Slot, { scope: e.__scopeRovingFocusGroup }, d(xr, P({}, e, { ref: t })))
        )
      );
    ...
    var xr = w((e, t) => {
        ...
        return (
          k(() => {
            let C = y.current;
            if (C) return (C.addEventListener(He, F), () => C.removeEventListener(He, F));
          }, [F]),
          d(
            vr,
            {
            ...
            d(
              se.div,
              P({ tabIndex: $ || Te === 0 ? -1 : 0, 'data-orientation': n }, p, {
                ref: S,
                ...
                onFocus: X(e.onFocus, (C) => {
                  ...
                  if (C.target === C.currentTarget && ae && !$) {
                    ...
                    if ((C.currentTarget.dispatchEvent(ue), !ue.defaultPrevented)) {
                      let ne = ce().filter((W) => W.focusable),
                        pe = ne.find((W) => W.active),
                        Y = ne.find((W) => W.id === h),
                        Ce = [pe, Y, ...ne].filter(Boolean).map((W) => W.ref.current);
                      Qt(Ce);
                    }
                  }
                  Q.current = !1;
      ...
      Xt = w((e, t) => {
        ...
        return (
          ...
          d(
            ...
            d(
              se.span,
              P({ tabIndex: p ? 0 : -1, 'data-orientation': s.orientation }, o, {
                ref: t,
    ...
    var ta = 'TabsList',
      aa = w((e, t) => {
        ...
        return d(
          Cr,
          P({ asChild: !0 }, o, { orientation: l.orientation, dir: l.dir, loop: n }),
          d(se.div, P({ role: 'tablist', 'aria-orientation': l.orientation }, i, { ref: t }))
        );
      });
          ...
          d(Zt, { present: i || p }, ({ present: S }) =>
            d(
              ...
              P(
                ...
                o,
                { ref: t, style: { ...e.style, animationDuration: y.current ? '0s' : void 0 } }
              ),
              S && l
            )
          )
    ...
    var Dr = ea,
      ...
      Wr = ({ id: e, item: t, type: a, selection: n, handleSelectionChange: i }) =>
        r.createElement(
          Gr,
          { id: e },
          r.createElement(
          ...
          r.createElement(
            Dr,
            { defaultValue: n, orientation: 'vertical', value: n, onValueChange: i, asChild: !0 },
            r.createElement(
              Br,
              null,
              r.createElement(
...
${u} {}`
    ...
    var zr = { minor: 'neutral', moderate: 'warning', serious: 'negative', critical: 'critical' },
      Kr = { minor: 'Minor', moderate: 'Moderate', serious: 'Serious', critical: 'Critical' },
      Xr = I.div(({ theme: e }) => ({
        display: 'flex',
        flexDirection: 'column',
        width: '100%',
                ...
                return r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement(Qr, { style: { transform: `rotate(${s ? -180 : 0}deg)` } })
                    )
                  ),
                  s
                    ? r.createElement(Wr, {
      ...
      ro = ({ tabs: e }) => {
        ...
        return d(
          ...
          d(De, {
            ...
            tabs: e.map((p) => ({ id: p.type, title: p.label, children: p.panel })),
            selected: t,
        ...
        return e.disable || e.test === 'off'
          ? r.createElement(
              ...
              r.createElement(
                'div',
                null,
                r.createElement('strong', null, 'Accessibility tests are disabled for this story'),
                r.createElement(
                  'p',
                  null,
                  'Update',
                ...
                : r.createElement(
                    ...
                    n === 'initial' &&
                      r.createElement(
                        ...
                        r.createElement('strong', null, 'Preparing accessibility scan'),
                        r.createElement('p', null, 'Please wait while the addon is initializing...')
                      ),
                    n === 'manual' &&
                      r.createElement(
                        r.Fragment,
                    ...
                    n === 'running' &&
                      r.createElement(
                        ...
                        null,
                        r.createElement(Ft, { size: 12 }),
                        r.createElement('strong', null, 'Accessibility scan in progress'),
                        r.createElement(
                          'p',
                          null,
                    ...
                    n === 'component-test-error' &&
                      r.createElement(
                        ...
                        r.createElement(
                          'div',
                          null,
                          r.createElement('strong', null, "This story's component tests failed"),
                          r.createElement(
                            'p',
                            null,
      ...
      fo = () => {
        ...
        return r.createElement(
          r.Fragment,
          null,
          e && r.createElement($t, { styles: { [`#${co}`]: { filter: ca(e.name) } } }),
          r.createElement(Ne, {
      ...
      yo = () => {
        let e = ie().getSelectedPanel(),
          ...
          l =
            i === 0
              ? null
              : r.createElement(z, { compact: !0, status: e === Se ? 'active' : 'neutral' }, i);
        return r.createElement(
          'div',
