...
(self.webpackChunkproject_name = self.webpackChunkproject_name || []).push([
  [2962],
  {
    './node_modules/storybook/dist/_browser-chunks/WithTooltip-IO6J4KBT.js'(
      ...
      var _chunk_45UGUKRX_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          './node_modules/storybook/dist/_browser-chunks/chunk-45UGUKRX.js'
        ),
        _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          './node_modules/storybook/dist/_browser-chunks/chunk-CHUV5WSW.js'
        ),
        _chunk_WJYERY3R_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        storybook_internal_client_logger__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          'storybook/internal/client-logger'
        ),
        _storybook_global__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__('@storybook/global'),
        ...
        require_react_fast_compare = (0, _chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.P$)({
          '../node_modules/react-fast-compare/index.js'(exports, module) {
            ...
            function equal(a, b) {
              ...
              if (a && b && 'object' == typeof a && 'object' == typeof b) {
                ...
                for (i = length; 0 !== i--; )
                  if (
                    (('_owner' !== keys[i] && '__v' !== keys[i] && '__o' !== keys[i]) ||
                      !a.$$typeof) &&
        ...
        require_warning = (0, _chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.P$)({
          '../node_modules/warning/warning.js'(exports, module) {
            var warning2 = function () {};
            module.exports = warning2;
          },
        }),
        import_memoizerific = (0, _chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.f1)(
          (0, _chunk_WJYERY3R_js__WEBPACK_IMPORTED_MODULE_2__.a)(),
          1
        ),
        fromEntries =
      ...
      function getBoundingClientRect(element, includeScale, isFixedStrategy) {
        ...
        includeScale &&
          isHTMLElement(element) &&
          ((scaleX =
            (element.offsetWidth > 0 && round(clientRect.width) / element.offsetWidth) || 1),
          (scaleY =
            (element.offsetHeight > 0 && round(clientRect.height) / element.offsetHeight) || 1));
        ...
        if (adaptive) {
          ...
          if (
            (offsetParent === getWindow(popper2) &&
              'static' !==
                getComputedStyle((offsetParent = getDocumentElement(popper2))).position &&
              'absolute' === position &&
              ((heightProp = 'scrollHeight'), (widthProp = 'scrollWidth')),
            placement === top ||
              ((placement === left || placement === right) && 'end' === variation))
          )
            ((sideY = bottom),
              (y -=
          ...
          if (!state.modifiersData[name]._skip) {
            for (
              var _options$mainAxis = options.mainAxis,
                ...
                placements2 = [preferredPlacement].concat(fallbackPlacements).reduce(function (
                  acc,
                  placement2
                ) {
                  return acc.concat(
                      ...
                      ? (function computeAutoPlacement(state, options) {
                          ...
                          var _options = options,
                            ...
                            allowedAutoPlacements =
                              void 0 === _options$allowedAutoP ? placements : _options$allowedAutoP,
                          ...
                          0 === allowedPlacements.length && (allowedPlacements = placements2);
        ...
        fn: function offset(_ref2) {
          var state = _ref2.state,
            ...
            data = placements.reduce(function (acc, placement) {
              return (
                (acc[placement] = (function distanceAndSkiddingToXY(placement, rects, offset2) {
            ...
            if (checkMainAxis) {
              var _offsetModifierState$,
                ...
                clientOffset = arrowOffsetParent
                  ...
                  : 0,
                offsetModifierValue =
                  null != (_offsetModifierState$ = offsetModifierState?.[mainAxis])
                    ? _offsetModifierState$
                    : 0,
                tetherMax = offset2 + maxOffset - offsetModifierValue,
                preventedOffset = within(
                  tether
                    ? min(min2, offset2 + minOffset - offsetModifierValue - clientOffset)
                    : min2,
                  offset2,
            ...
            if (checkAltAxis) {
              var _offsetModifierState$2,
                ...
                _offsetModifierValue =
                  null != (_offsetModifierState$2 = offsetModifierState?.[altAxis])
      ...
      function popperGenerator(generatorOptions) {
        ...
        var _generatorOptions = generatorOptions,
          ...
          defaultModifiers3 = void 0 === _generatorOptions$def ? [] : _generatorOptions$def,
      ...
      var createPopper3 = popperGenerator({
        ...
        import_react_fast_compare = (0, _chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.f1)(
          require_react_fast_compare()
        ),
        EMPTY_MODIFIERS = [];
      (0, _chunk_A242L54C_js__WEBPACK_IMPORTED_MODULE_3__.f1)(require_warning());
      ...
      function usePopperTooltip(config, popperOptions) {
        ...
        (void 0 === config && (config = {}), void 0 === popperOptions && (popperOptions = {}));
        var finalConfig = Object.keys(defaultConfig).reduce(function (config2, key) {
            var _extends2;
            return (0, _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__.r)(
              {},
              config2,
              (((_extends2 = {})[key] =
          ...
          finalPopperOptions = (0, _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__.r)(
            {},
            popperOptions,
            {
              ...
              set = react__WEBPACK_IMPORTED_MODULE_4__.useCallback(
                function (updater) {
                  var state2 = getLatest(),
                    updatedState = 'function' == typeof updater ? updater(state2) : updater;
                  ('function' == typeof updatedState.persist && updatedState.persist(),
        ...
        var _usePopper = (function (referenceElement, popperElement, options) {
              ...
              useIsomorphicLayoutEffect(
                function () {
                  if (null != referenceElement && null != popperElement) {
                    var popperInstance = (options.createPopper || createPopper3)(
                      referenceElement,
                      popperElement,
                      popperOptions
                    );
          ...
          popperProps = (0, _chunk_45UGUKRX_js__WEBPACK_IMPORTED_MODULE_0__.i)(
            _usePopper,
            _excluded
          ),
        ...
        return (0, _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__.r)(
          {
            getArrowProps: function (args) {
              return (
                void 0 === args && (args = {}),
                (0, _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__.r)({}, args, attributes.arrow, {
                  style: (0, _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__.r)(
                    {},
                    args.style,
                    styles.arrow
                  ),
            ...
            getTooltipProps: function (args) {
              return (
                void 0 === args && (args = {}),
                (0, _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__.r)(
                  {},
                  args,
                  {
                    style: (0, _chunk_CHUV5WSW_js__WEBPACK_IMPORTED_MODULE_1__.r)(
      ...
      var { document: document2 } = _storybook_global__WEBPACK_IMPORTED_MODULE_7__.global,
        match = (0, import_memoizerific.default)(1e3)((requests, actual, value, fallback = 0) =>
          ...
          ({ theme, color, placement }) => ({
            ...
            borderTopColor: match(
              ...
              theme.color[color] || color || 'light' === theme.base
                ? (0, storybook_theming__WEBPACK_IMPORTED_MODULE_9__.Zt)(theme.background.app)
        ...
        Wrapper = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.I4.div(
          ...
          ({ theme, color, hasChrome }) =>
            hasChrome
              ? {
                  background:
                    (color && theme.color[color]) || color || 'light' === theme.base
                      ? (0, storybook_theming__WEBPACK_IMPORTED_MODULE_9__.Zt)(theme.background.app)
                      : theme.background.app,
                  filter:
      ...
      var TargetContainer = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.I4.div`
  display: inline-block;
  cursor: ${(props) => ('hover' === props.trigger || props.trigger?.includes('hover') ? 'default' : 'pointer')};
`,
        TargetSvgContainer = storybook_theming__WEBPACK_IMPORTED_MODULE_8__.I4.g`
  cursor: ${(props) => ('hover' === props.trigger || props.trigger?.includes('hover') ? 'default' : 'pointer')};
`,
        WithTooltipPure = ({
          svg = !1,
          ...
          return react__WEBPACK_IMPORTED_MODULE_4__.createElement(
            ...
            isVisible &&
              react_dom__WEBPACK_IMPORTED_MODULE_5__.createPortal(tooltipComponent, portalTarget)
          );
        },
        WithToolTipState = ({ startOpen = !1, onVisibleChange: onChange, ...rest }) => {
          let [tooltipShown, setTooltipShown] = (0, react__WEBPACK_IMPORTED_MODULE_4__.useState)(
              startOpen
            ),
            onVisibilityChange = (0, react__WEBPACK_IMPORTED_MODULE_4__.useCallback)(
              (visibility) => {
        ...
        DeprecatedPure = (props) => (
          (0, storybook_internal_client_logger__WEBPACK_IMPORTED_MODULE_6__.deprecate)(
...
//# sourceMappingURL=2962.4041d6ba.iframe.bundle.js.map
