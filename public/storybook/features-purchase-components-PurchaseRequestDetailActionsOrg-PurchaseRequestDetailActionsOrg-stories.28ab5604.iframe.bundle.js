    ...
    './src/features/purchase/components/PurchaseRequestDetailActionsOrg/PurchaseRequestDetailActionsOrg.stories.tsx'(
      ...
      (__webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          AdminActionsInsufficientBudget: () => AdminActionsInsufficientBudget,
          UserActions: () => UserActions,
          UserActionsWithoutCompanyId: () => UserActionsWithoutCompanyId,
      ...
      const __WEBPACK_DEFAULT_EXPORT__ = {
        ...
        UserActions = {
          args: { companyId: 'company-123', actionType: 'user' },
          parameters: {
            docs: {
              description: {
                story:
        ...
        AdminActionsInsufficientBudget = {
          args: {
            companyId: 'company-123',
            actionType: 'admin',
            onApproveClick: () => {},
        ...
        UserActionsWithoutCompanyId = {
          args: { companyId: void 0, actionType: 'user' },
          parameters: {
            docs: {
              description: {
                story:
      ...
      ((UserActions.parameters = {
        ...UserActions.parameters,
        docs: {
          ...UserActions.parameters?.docs,
          source: {
            originalSource:
              "{\n  args: {\n    companyId: 'company-123',\n    actionType: 'user'\n  },\n  parameters: {\n    docs: {\n      description: {\n        story: '사용자용 액션 버튼입니다. 자신이 요청한 구매 내역을 확인할 때 표시됩니다.\\n\\n**버튼 구성:**\\n- 목록 보기 (Secondary): `/{companyId}/my/purchase-requests`로 이동\\n- 장바구니 다시 담기 (Primary): `/{companyId}/cart`로 이동\\n\\n**동작:**\\n- companyId가 없으면 버튼 비활성화 및 Toast 표시\\n- 버튼 클릭 시 해당 경로로 라우팅\\n\\n**레이아웃:**\\n- 모바일/태블릿: 화면 하단 고정\\n- 데스크톱: 콘텐츠 하단에 배치'\n      }\n    }\n  }\n}",
            ...UserActions.parameters?.docs?.source,
          },
        },
      }),
        (AdminActions.parameters = {
          ...AdminActions.parameters,
          docs: {
            ...AdminActions.parameters?.docs,
            source: {
              originalSource:
                "{\n  args: {\n    companyId: 'company-123',\n    actionType: 'admin',\n    onApproveClick: () => {},\n    onRejectClick: () => {},\n    isBudgetSufficient: true\n  },\n  parameters: {\n    docs: {\n      description: {\n        story: '관리자용 액션 버튼입니다. 구매 요청을 검토하고 승인/반려할 때 표시됩니다.\\n\\n**버튼 구성:**\\n- 요청 반려 (Secondary): onRejectClick 콜백 호출\\n- 요청 승인 (Primary): onApproveClick 콜백 호출\\n\\n**동작:**\\n- 승인 버튼 클릭 시 승인 모달 표시 (부모 컴포넌트에서 처리)\\n- 반려 버튼 클릭 시 반려 모달 표시 (부모 컴포넌트에서 처리)\\n- isBudgetSufficient=false면 승인 버튼 비활성화\\n\\n**레이아웃:**\\n- 모바일/태블릿: 화면 하단 고정\\n- 데스크톱: 콘텐츠 하단에 배치'\n      }\n    }\n  }\n}",
              ...AdminActions.parameters?.docs?.source,
            },
          },
        }),
        (AdminActionsInsufficientBudget.parameters = {
          ...AdminActionsInsufficientBudget.parameters,
          docs: {
            ...AdminActionsInsufficientBudget.parameters?.docs,
            source: {
              originalSource:
                "{\n  args: {\n    companyId: 'company-123',\n    actionType: 'admin',\n    onApproveClick: () => {},\n    onRejectClick: () => {},\n    isBudgetSufficient: false\n  },\n  parameters: {\n    docs: {\n      description: {\n        story: '예산이 부족한 경우의 관리자용 액션 버튼입니다.\\n\\n**특징:**\\n- isBudgetSufficient=false로 설정\\n- 요청 승인 버튼이 비활성화 상태로 표시됨\\n- 요청 반려 버튼은 정상 작동\\n\\n**사용 시나리오:**\\n- 구매 후 예산이 음수가 되는 경우\\n- 월 예산을 초과하는 구매 요청\\n- 관리자가 예산 부족을 이유로 승인할 수 없는 경우\\n\\n**UX:**\\n- 승인 버튼이 inactive 상태로 시각적 피드백 제공\\n- 사용자는 반려만 가능하며, 승인은 불가능함을 명확히 인지'\n      }\n    }\n  }\n}",
              ...AdminActionsInsufficientBudget.parameters?.docs?.source,
            },
          },
        }),
        (UserActionsWithoutCompanyId.parameters = {
          ...UserActionsWithoutCompanyId.parameters,
          docs: {
            ...UserActionsWithoutCompanyId.parameters?.docs,
            source: {
              originalSource:
                "{\n  args: {\n    companyId: undefined,\n    actionType: 'user'\n  },\n  parameters: {\n    docs: {\n      description: {\n        story: 'companyId가 없는 경우의 사용자용 액션 버튼입니다.\\n\\n**특징:**\\n- companyId prop이 제공되지 않음\\n- 두 버튼 모두 비활성화 상태\\n- 버튼 클릭 시 Toast 에러 메시지 표시: \"회사가 선택되지 않았습니다.\"\\n\\n**사용 시나리오:**\\n- 라우팅 파라미터에서 companyId를 가져오지 못한 경우\\n- 잘못된 URL로 접근한 경우\\n- 개발 중 props 전달 누락\\n\\n**UX:**\\n- 버튼이 비활성화되어 클릭할 수 없음을 시각적으로 표시\\n- 클릭 시도 시 Toast로 에러 원인 안내\\n- 3초 후 Toast 자동 닫힘'\n      }\n    }\n  }\n}",
              ...UserActionsWithoutCompanyId.parameters?.docs?.source,
            },
          },
        }));
    },
